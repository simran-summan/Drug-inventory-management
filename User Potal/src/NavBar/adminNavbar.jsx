  ...
  return (
    <div className="h-14 text-xl w-full bg-gray-800 text-white flex">
      ...
      <div className="flex justify-end m-1 pr-10">
        <Link
          to="/login"
          className="text-white border-2 border-white hover:bg-gray-700 hover:text-white px-6 py-1 rounded-lg transition duration-300 font-semibold my-1 text-[17px]"
        >
          Logout
        </Link>
      </div>
